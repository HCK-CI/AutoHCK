...
module AutoHCK
  ...
  class CLI < T::Struct
    ...
    prop :test, T.nilable(TestOptions), factory: -> { TestOptions.new }
    prop :common, T.nilable(CommonOptions), factory: -> { CommonOptions.new }
    prop :install, T.nilable(InstallOptions), factory: -> { InstallOptions.new }
