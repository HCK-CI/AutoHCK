...
module AutoHCK
  ...
  autoload_relative :Functest, 'engines/functest/functest_models'
  autoload_relative :FunctestClient, 'setupmanagers/functest_client'
  autoload_relative :FunctestEngine, 'engines/functest/functest'
  autoload_relative :InstallDuringSetup, 'engines/install_during_setup'
  autoload_relative :InstallTestEngine, 'engines/installtest/installtest'
  autoload_relative :InstallTestClient, 'setupmanagers/installtest_client'
  autoload_relative :FunctestTools, 'engines/functest/functest_tools'
  ...
  autoload_relative :MemoryDumpCollector, 'auxiliary/memory_dump_collector'
