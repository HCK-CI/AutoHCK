...
# pkg:gem/aws-sdk-core#lib/aws-sdk-core/xml/parser/rexml_engine.rb:9
class Aws::Xml::Parser::RexmlEngine
  include ::REXML::StreamListener

  # pkg:gem/aws-sdk-core#lib/aws-sdk-core/xml/parser/rexml_engine.rb:13
  def initialize(stack); end

  # pkg:gem/aws-sdk-core#lib/aws-sdk-core/xml/parser/rexml_engine.rb:18
  def parse(xml); end

  # pkg:gem/aws-sdk-core#lib/aws-sdk-core/xml/parser/rexml_engine.rb:40
  def tag_end(name); end

  # pkg:gem/aws-sdk-core#lib/aws-sdk-core/xml/parser/rexml_engine.rb:28
  def tag_start(name, attrs); end

  # pkg:gem/aws-sdk-core#lib/aws-sdk-core/xml/parser/rexml_engine.rb:36
  def text(value); end
end
