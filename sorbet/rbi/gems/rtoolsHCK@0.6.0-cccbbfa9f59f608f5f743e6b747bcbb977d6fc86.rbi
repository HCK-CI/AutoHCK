...
class RToolsHCK
  ...
  # Closes the instance.
  #
  # source://rtoolsHCK//lib/rtoolsHCK.rb#1498
  def close; end
  ...
  # @return [Boolean]
  #
  # source://rtoolsHCK//lib/rtoolsHCK.rb#1511
  def closed?; end
  ...
  #
  # source://rtoolsHCK//lib/rtoolsHCK.rb#1055
  ...
  #
  # source://rtoolsHCK//lib/rtoolsHCK.rb#1239
  ...
  #
  # source://rtoolsHCK//lib/rtoolsHCK.rb#1207
  ...
  #
  # source://rtoolsHCK//lib/rtoolsHCK.rb#1079
  ...
  #
  # source://rtoolsHCK//lib/rtoolsHCK.rb#1392
  ...
  # == Description
  #
  # Lists all tests's results info.
  #
  # == Params:
  #
  # +target+::       The key of the target, use list_machine_targets to get it
  ...
  # +pool+::         The name of the pool
  #
  # source://rtoolsHCK//lib/rtoolsHCK.rb#889
  def list_all_results(target, project, machine, pool); end
  ...
  #
  # source://rtoolsHCK//lib/rtoolsHCK.rb#1170
  ...
  #                  default
  #
  # source://rtoolsHCK//lib/rtoolsHCK.rb#1115
  ...
  #
  # source://rtoolsHCK//lib/rtoolsHCK.rb#1189
  ...
  # source://rtoolsHCK//lib/rtoolsHCK.rb#1260
  def do_download_from_machine(machine, r_path, l_path); end

  # @return [Boolean]
  #
  # source://rtoolsHCK//lib/rtoolsHCK.rb#1271
  ...
  # source://rtoolsHCK//lib/rtoolsHCK.rb#1319
  ...
  # source://rtoolsHCK//lib/rtoolsHCK.rb#1018
  ...
  # source://rtoolsHCK//lib/rtoolsHCK.rb#940
  ...
  # source://rtoolsHCK//lib/rtoolsHCK.rb#1340
  def install_certificate(machine, windows_path, sys_file = T.unsafe(nil)); end

  # source://rtoolsHCK//lib/rtoolsHCK.rb#1298
  def install_certificate_script(cer_path); end

  # source://rtoolsHCK//lib/rtoolsHCK.rb#1328
  ...
  # source://rtoolsHCK//lib/rtoolsHCK.rb#1005
  def package_progression_first_step(cmd_line, handler); end

  # source://rtoolsHCK//lib/rtoolsHCK.rb#1011
  ...
  # source://rtoolsHCK//lib/rtoolsHCK.rb#1426
  def priv_close; end
  ...
  # source://rtoolsHCK//lib/rtoolsHCK.rb#1439
  def unload_ether; end

  # source://rtoolsHCK//lib/rtoolsHCK.rb#1445
...
#
# source://rtoolsHCK//lib/rtoolsHCK.rb#1028
