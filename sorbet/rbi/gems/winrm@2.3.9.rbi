...
class WinRM::ConnectionOpts < ::Hash
  # source://winrm//lib/winrm/connection_opts.rb#60
  def validate; end

  private

  # source://winrm//lib/winrm/connection_opts.rb#78
  def validate_data_types; end

  # source://winrm//lib/winrm/connection_opts.rb#86
  def validate_integer(key, min = T.unsafe(nil)); end

  # source://winrm//lib/winrm/connection_opts.rb#67
  def validate_required_fields; end

  class << self
    # source://winrm//lib/winrm/connection_opts.rb#29
    def create_with_defaults(overrides); end

    private

    # source://winrm//lib/winrm/connection_opts.rb#45
    def default; end

    # source://winrm//lib/winrm/connection_opts.rb#38
...
# source://winrm//lib/winrm/connection_opts.rb#26
WinRM::ConnectionOpts::DEFAULT_USER_AGENT = T.let(T.unsafe(nil), String)
...
class WinRM::HTTP::HttpGSSAPI < ::WinRM::HTTP::HttpTransport
  ...
  #
  # source://winrm//lib/winrm/http/transport.rb#295
  ...
  #
  # source://winrm//lib/winrm/http/transport.rb#313
  def send_request(message); end

  private

  # source://winrm//lib/winrm/http/transport.rb#353
  def init_krb; end
...
class WinRM::HTTP::HttpNegotiate < ::WinRM::HTTP::HttpTransport
  ...
  #
  # source://winrm//lib/winrm/http/transport.rb#149
  def initialize(endpoint, user, pass, opts); end

  # source://winrm//lib/winrm/http/transport.rb#168
  def send_request(message); end

  private

  # source://winrm//lib/winrm/http/transport.rb#250
  def channel_binding(response); end

  # source://winrm//lib/winrm/http/transport.rb#230
  def init_auth; end

  # source://winrm//lib/winrm/http/transport.rb#215
  def issue_challenge_response(negotiate); end

  # source://winrm//lib/winrm/http/transport.rb#194
  def seal(message); end

  # @raise [WinRMHTTPTransportError]
  #
  # source://winrm//lib/winrm/http/transport.rb#200
...
class WinRM::HTTP::HttpPlaintext < ::WinRM::HTTP::HttpTransport
  ...
  #
  # source://winrm//lib/winrm/http/transport.rb#138
  def initialize(endpoint, user, pass, opts); end
end
...
class WinRM::HTTP::HttpTransport
  ...
  #
  # source://winrm//lib/winrm/http/transport.rb#57
  ...
  #
  # source://winrm//lib/winrm/http/transport.rb#69
  def no_ssl_peer_verification!; end

  # Disable SSPI Auth
  #
  # source://winrm//lib/winrm/http/transport.rb#63
...
class WinRM::Shells::Base
  ...
  # source://winrm//lib/winrm/shells/base.rb#119
  ...
  # source://winrm//lib/winrm/shells/base.rb#129
  def with_command_shell(command, arguments = T.unsafe(nil)); end

  private

  # source://winrm//lib/winrm/shells/base.rb#180
  def add_finalizer; end

  # source://winrm//lib/winrm/shells/base.rb#153
  def cleanup_command(command_id); end

  # source://winrm//lib/winrm/shells/base.rb#170
  def open; end

  # source://winrm//lib/winrm/shells/base.rb#187
  def remove_finalizer; end

  # source://winrm//lib/winrm/shells/base.rb#147
  def reset_on_error(error); end

  class << self
    # source://winrm//lib/winrm/shells/base.rb#97
...
class WinRM::Shells::Cmd < ::WinRM::Shells::Base
  ...
  # source://winrm//lib/winrm/shells/cmd.rb#54
  def out_streams; end

  # source://winrm//lib/winrm/shells/cmd.rb#44
  def response_reader; end

  # source://winrm//lib/winrm/shells/cmd.rb#31
...
class WinRM::Shells::Powershell < ::WinRM::Shells::Base
  ...
  #
  # source://winrm//lib/winrm/shells/power_shell.rb#46
  ...
  #
  # source://winrm//lib/winrm/shells/power_shell.rb#69
  ...
  # @yieldreturn [Array<Message>] All messages in response
  #
  # source://winrm//lib/winrm/shells/power_shell.rb#56
  def send_pipeline_command(command, &block); end

  protected

  # source://winrm//lib/winrm/shells/power_shell.rb#114
  def open_shell; end

  # source://winrm//lib/winrm/shells/power_shell.rb#127
  def out_streams; end

  # source://winrm//lib/winrm/shells/power_shell.rb#92
  def response_reader; end
  ...
  # source://winrm//lib/winrm/shells/power_shell.rb#133
  ...
  #
  # source://winrm//lib/winrm/shells/power_shell.rb#193
  ...
  # source://winrm//lib/winrm/shells/power_shell.rb#145
  def max_envelope_size_kb; end

  # source://winrm//lib/winrm/shells/power_shell.rb#157
  def open_shell_payload(shell_id); end

  # source://winrm//lib/winrm/shells/power_shell.rb#166
